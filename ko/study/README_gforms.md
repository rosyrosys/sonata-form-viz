...
자동 생성된 Form 의 §D 에는 `D1. [SUS Item 1 — 김주현 외 (2014) 한국어판 본문 입력]` 같은 자리표시자가 있습니다.

각 자리에 **김주현, 박준영, 이상호 (2014). 「한국어판 시스템 사용성 척도(K-SUS) 의 타당화 연구」, 한국HCI학회 논문지, 9(2), 31–40** 의 공식 한국어판 SUS 본문 10개를 직접 복사해 넣으세요. 본 스크립트가 본문을 자동 삽입하지 않는 이유는:
